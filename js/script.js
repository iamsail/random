...
$(function(){
	...
	$(".start").click(function(){
		...
		//time = setInterval("gaocf()",30);$("#chengfa").animate({fontSize:"35px"});
		time = setInterval("gaocf()",30);$("#chengfa").animate({fontSize:"25px"});
		$(".start,.over").toggle();
	});
	...
	$(".over").click(function(){
		...
		//$("#chengfa").animate({fontSize:"20px"}).animate({fontSize:"35px"});
		$("#chengfa").animate({fontSize:"20px"}).animate({fontSize:"25px"});
